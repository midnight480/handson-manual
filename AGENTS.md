...
Start by reading `.aidlc-rule-details/common/process-overview.md` and follow the core workflow.

### AI-DLC Core Workflow Reference

The full core workflow rules are located at `.kiro/steering/aws-aidlc-rules/core-workflow.md`. Read this file to understand the complete adaptive software development workflow including:

- **INCEPTION PHASE**: Workspace Detection, Reverse Engineering, Requirements Analysis, User Stories, Workflow Planning, Application Design, Units Generation
- **CONSTRUCTION PHASE**: Functional Design, NFR Requirements, NFR Design, Infrastructure Design, Code Generation, Build and Test
- **OPERATIONS PHASE**: Placeholder for future deployment workflows
